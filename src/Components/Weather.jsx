...
function Weather() {
  ...
  return (
    <>
      <div className="place-self-center w-[95%] sm:w-[80%] lg:w-1/3 min-h-[75%] h-fit p-10 pb-10 rounded-xl bg-gradient-to-tr from-blue-800 via-blue-500 to-purple-400 flex flex-col items-center">
        ...
        {weatherData.icon && !fetchError ? (
          <>
            ...
            <div className="text-white w-full mt-10 flex justify-between">
              ...
              <div className="flex items-start gap-3 text-md">
                <img className="w-6 mt-3" src={windWeather} alt="wind icon" />
                <div>
